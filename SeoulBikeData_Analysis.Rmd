...
MonthlyMeanSolarRadiation = c(MonthlyMeanSolarRadiation[5], MonthlyMeanSolarRadiation[4], MonthlyMeanSolarRadiation[8], MonthlyMeanSolarRadiation[1], MonthlyMeanSolarRadiation[9], MonthlyMeanSolarRadiation[7], MonthlyMeanSolarRadiation[6], MonthlyMeanSolarRadiation[2], MonthlyMeanSolarRadiation[12], MonthlyMeanSolarRadiation[11], MonthlyMeanSolarRadiation[3])
...
```{r}
summary(bike.data$Rainfall)
myData$Month = format(myData$Date, "%b")
DailyMaxRF <- tapply(myData$Rainfall, myData$Month, FUN=max)
DailyMaxRF = c(DailyMaxRF[5], DailyMaxRF[4], DailyMaxRF[8], DailyMaxRF[1], DailyMaxRF[9], DailyMaxRF[7], DailyMaxRF[6], DailyMaxRF[2], DailyMaxRF[12], DailyMaxRF[11], DailyMaxRF[3])
...
```{r}
summary(bike.data$Snowfall)
myData$Month = format(myData$Date, "%b")
sortedm <- myData[order(myData$Month),]
DailyMaxSF <- tapply(myData$Snowfall, myData$Month, FUN=max)
DailyMaxSF = c(DailyMaxSF[5], DailyMaxSF[4], DailyMaxSF[8], DailyMaxSF[1], DailyMaxSF[9], DailyMaxSF[7], DailyMaxSF[6], DailyMaxSF[2], DailyMaxSF[12], DailyMaxSF[11], DailyMaxSF[3])
